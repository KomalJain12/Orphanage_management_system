		            ...
		            <div class="col-lg-8 col-md-12">
		                <div class="contact-info-here mb-30">
		                    ...
		                    <div class="contact-info">
		                        ...
		                        <p>Inquiries can be done on the basis of any queries you have you can ask anything related to the organisation and can also know about the future updates about the organisation as well</p>
		                    </div>
		                </div>
		            </div>
		        ...
		        <div class="row no-gutters">
		            <div class="col-md-12 col-lg-8 gray-bg">
                        <div class="contact-form-wrap">
                            ...
                            <form  action=contactus_Servlet method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="contact-form-style mb-30">
                                        <input type="text" name="email" id="input-file-now" placeholder="Enter your email" />
                                        </div>                                                                                                                                                                                                                                                                 
                                    </div>
