			...
			<div class="col-xl-3 col-12">
				<div class="box-content">
					<div class="statistics-box with-icon">
						...
						<h2 class="counter text-inverse"><% try
                                {
                                    
                                
                                Statement st=con.createStatement();
                                String cnt = "select count(inq_id) from inquiry_master";
				...
				<div class="box-content">
					<div class="statistics-box with-icon">
						...
						<h2 class="counter text-success"><% try
                                {
                                    
                                
                                Statement st=con.createStatement();
                                String cnt = "select count(blog_id) from blog_master;
		                        ResultSet rslt = st.executeQuery(cnt);
