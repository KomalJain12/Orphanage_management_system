...
<!-- Mirrored from coderthemes.com/adminto/layouts/auth-logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 18 Sep 2022 14:06:54 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Logout | Family - Admin Dashboard Template</title>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-muted"> You are now successfully sign out. </p>
                                     <p class="text-muted">Back to <a href="index.jsp" class="text-dark ms-1"><b>Sign In</b></a></p>
                                </div>
